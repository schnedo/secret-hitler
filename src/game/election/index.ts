...
export { default as nextPresidentialCandidate } from "./nextPresidentialCandidate";
export { default as FailedElectionCounter } from "./components/FailedElectionCounter";
